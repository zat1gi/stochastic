...
set xlabel "Position in Slab" font "Times-Roman, 30" offset 0,-2
...
#Enter Plotline
plot "txt/genRealzplot21.txt" using 1:2 with lines t "Realization 3" ls 3,\
     "txt/KLrrealzplot.txt" using 1:2 with lines t "KL Realization 1" ls 4

#Postscript info
set size 1.0,0.6
set terminal postscript portrait enhanced color dashed lw 2 "Times-Roman" 11
set output './genRealz_KLrrealz3.ps'
#Screen output
replot
pause 1