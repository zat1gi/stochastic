...
CONTAINS
  ...
  use KLvars,               only: KLvarcalc, KLvarkept_tol
  ...
  subroutine testinputstoc( pltEigfnumof,pltEigfwhich,numEigs,pltxiBinsnumof,&
  ...
  integer :: pltEigfwhich(:),pltxiBinswhich(:,:),pltKLrrealzwhich(:,:),pltgenrealzwhich(:)
  integer :: pltCowhich(:,:)
  integer :: trannprt
